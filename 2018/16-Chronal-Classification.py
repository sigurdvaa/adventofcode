...
Opcode.ops.extend(
    [
        ...
        Opcode("banr", lambda regs, ins: regs[ins[1]] & regs[ins[2]]),
        Opcode("bani", lambda regs, ins: regs[ins[1]] & ins[2]),
        Opcode("borr", lambda regs, ins: regs[ins[1]] | regs[ins[2]]),
        Opcode("bori", lambda regs, ins: regs[ins[1]] | ins[2]),
